...
export default function ProductCard(props){
    ...
    return <div className="bg-black hover:scale-105 duration-150 relative " onMouseEnter={()=>{
        setChheck(true)
    }}
    onMouseLeave={()=>{
        setChheck(false)
    ...
    className={`h-96 w-96 -translate-x-2 -translate-y-2  border-2 border-orange-800 ${props.bg} flex flex-col justify-around items-start text-amber-950`}>
        ...
        <div className="absolute -top-8 h-20 w-20 -right-8 rounded-full border-2 border-orange-800">
        <img src="https://marketplace.canva.com/EAFaFUz4aKo/2/0/1600w/canva-yellow-abstract-cooking-fire-free-logo-JmYWTjUsE-Q.jpg" alt="photo" className="h-full w-full object-cover rounded-full"></img>
        </div>
